...
public class EditDetailsAsOccupied {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		//Navigate to update details as occupied
		driver.findElement(By.xpath("//a[.='Details/Update']")).click();
		driver.findElement(By.xpath("//a[.='Edit']")).click();
		Select sl = new Select(driver.findElement(By.id("vacant")));
		sl.selectByIndex(1);
		driver.findElement(By.xpath("//button[.='Submit']")).click();
		// navigate sms module and send sms to all users
		driver.findElement(By.xpath("//a[.='Send SMS']")).click();
		driver.findElement(By.id("selectAll")).click();
		driver.findElement(By.name("message")).sendKeys("water is not coming");
