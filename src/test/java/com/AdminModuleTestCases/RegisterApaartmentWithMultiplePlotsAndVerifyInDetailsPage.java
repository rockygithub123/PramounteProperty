...
public class RegisterApaartmentWithMultiplePlotsAndVerifyInDetailsPage {
	...
	public static void main(String[] args) throws Throwable {
		...
		try {
			...
			// click on add more apartment
			driver.findElement(By.xpath("//a[text()='Add More(Plat Number/Description)']")).click();
			//enter the full name
			driver.findElement(By.xpath("//input[@type='fullname']")).sendKeys("name");
			//to enter the flat number
			driver.findElement(By.xpath("//input[@type=\"ap_number_of_plats\"]")).sendKeys(PlotNumber);
			//to enter type of rooms
			driver.findElement(By.xpath("//input[@type=\"rooms\"]")).sendKeys("1bhk");
			//to select type 
			WebElement ele = driver.findElement(By.xpath("//select[@id='purpose']"));
			wlib.select(ele, 0);
			//to select floor
			WebElement ele1 = driver.findElement(By.xpath("//select[@id='floor']"));
			wlib.select(ele1, "3rd");
			//to enter the description
			driver.findElement(By.xpath("//div[@id='addedRows']/descendant::input[@id='description']")).sendKeys("no");
