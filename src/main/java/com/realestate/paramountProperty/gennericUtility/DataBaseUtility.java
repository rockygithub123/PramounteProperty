...
public class DataBaseUtility {static Driver driver;
...
public void connectDB() throws SQLException {
	try {
		...
		connection=DriverManager.getConnection(IConstatants.Jdbc_Url_String,IConstatants.Jdbc_UserName,IConstatants.Jdbc_PassWord);
